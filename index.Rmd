...
O R frustra e assusta! Às vezes traumatiza. 

Muitos ficaram traumatizados com o R e não podem mais ouvir falar nele...

Mas ouvirão, e muito! O R veio para ficar, para sempre. 

Mas acredito que o aprendizado do R não precisa ser traumático. Talvez possa ser até agradável.

**O R é para todos!**

Conheci o R em 2001, mas demorei uns três anos para tomar coragem e começar a aprender sozinho.  

O R assustou até a mim, que adoro estatística.

Mas o susto passa rápido, você logo vai perceber. Para mim, a única desvantagem do R é justamente essa: a sua curva de aprendizado é relativamente inclinada! Mas após superar o primeiro passo, que é o mais difícil, você vai entender as vantagens do R são inúmeras e, quando o susto passar, vai sentir uma imensa alegria em poder fazer as suas coisas no R.
...
Aprender o R e aprender estatística não são a mesma coisa. Muitos acham que, aprendendo o R, automaticamente aprenderão estatística! Este livro não se propõe a ensinar estatítica. Para isso existem muitos outros bons livros por aí. Aqui você aprenderá a usar o R como ferramenta e fazer algumas coisas interessantes com ele. Você aprenderá fazendo, usando códigos prontos e testados, muitas vezes difíceis de encontrar em outros lugares. O objetivo deste livro é funcionar como um manual de consultas, ou de receitas, onde você poderá recorrer em caso de necessidade. Para fazer pesquisa rápida sobre um tema em todo o livro, use o botão com a lupa acima nesta página.

Este livro está sendo escrito usando... o R! O pacote do R `bookdown` fornece ferramentas de edição de livros usando a linguagem `rmarkdown`, que é de fácil aprendizado e cujos funcionamentos estão descritos no capítulo ????. 
...
O livro está hospedado em https://github.com/mauricio-camargo/rparatodos e pode ser acessado livremente. Se você quiser contribuir para o livro, pode usar os recursos de edição do `github`, que pode ser acessado pelo botão na parte superior desta página.
