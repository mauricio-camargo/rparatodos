...
O R frustra e assusta! De vez em quando, traumatiza. 

Muita gente ficou traumatizada com o R e não pode mais ouvir falar nele...

Mas irão, e muito! O R veio para ficar, para sempre. 

Então talvez tenha chegado a hora de mostrar que o aprendizado do R não precisa ser traumático e que talvez possa até ser agradável.
...
Mas você verá que o susto passa rápido. Talvez  a única desvantagem do R seja justamente essa: a sua curva de aprendizado é relativamente inclinada! Mas após superar o primeiro passo, que é o mais difícil, você vai entender as vantagens do R, que são inúmeras, e quando o susto passar, vai sentir uma imensa alegria em poder fazer as suas coisas no R.
