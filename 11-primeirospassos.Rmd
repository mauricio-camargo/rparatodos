...
a=c('Ctrl+Enter','Ctrl+O','Ctrl+PgUp','Ctrl+PgDw','Ctrl+S')
b=c('Enviar o código da linha atual para o console do R','Abrir um arquivo   ','Aba de scritp anterior','Aba de scritp seguinte','Salva o documento atual')
d=data.frame(a,b)
